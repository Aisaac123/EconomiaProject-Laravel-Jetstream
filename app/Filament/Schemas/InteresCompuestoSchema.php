...
class InteresCompuestoSchema
{
                                    ...
                                    Grid::make(1)->schema([
                                        Placeholder::make('_')
                                            ...
                                            ->content(function (callable $get): Htmlable {
                                                ...
                                                // Contar campos vacíos CORRECTAMENTE (solo los 4 principales)
                                                $emptyFields = [];
                                                ...
                                                if ($campoCalculado && ($resultado || $resultado2)) {
                                                    return static::buildResultHtmlCompuesto(
                                                        ...
                                                        $mensaje, $campoCalculado, $tipoTasa, $resultado, $resultado2
                                                    );
                                                }
    ...
    protected static function buildResultHtmlCompuesto(
        $capital, $montoFinal, $tasaInteres, $tiempo,
